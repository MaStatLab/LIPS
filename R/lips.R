lips = function( Y, X, T = NULL, kstep = 0, alpha = NULL, method = "g", nparticle = 100, rho0=0.5, rho0.method ="beta-binomial",rho.prop=0.1,p.mix=0,resample.param=1,n.top.vars=5){
